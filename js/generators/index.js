import * as attractor from './attractor.js?v=50';
import * as radial from './radial.js?v=50';
import * as cymatics from './cymatics.js?v=50';
import * as harmonic from './harmonic.js?v=50';
import * as oscillo from './oscillo.js?v=50';
